SUMMARY = "DELIA UI for DELIA OS."
HOMEPAGE = "https://github.com/Melbourne-Instruments/delia_ui"
...
PV = ""
SRC_URI = "gitsm://github.com/Melbourne-Instruments/delia_ui.git"
...
do_install() {
    install -d ${D}${bindir}
    install -m 0755 delia_ui ${D}${bindir}
}
